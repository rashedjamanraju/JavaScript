...
REFERENCE TYPE DATA:
যখন আমরা একটি variable  এ reference type data ইনপুট করি এবং অন্য আরেকটি variable এ যদি আমরা ঐ আগের variable এ ইনপুট করা value কে  ইনপুট করি 
...
আরেকটি data ইনপুট করলে ২য় variable এর value এর মধ্যেও পরিবর্তন আসবে ।
এর একমাত্র কারন হচ্ছে ২টি variable এরই memody location/memory adress একই হয়ে যাওয়া।*/
//EXAMPLE:
//01.
